...
class ProfileTest {
    ...
    void fieldsCannotBeNull(Validator validator) {
        assertThat(validator.validate(new Profile("xx", "email", null, null, null, null, null, null, null, null)))
    ...
    void validProfile(Validator validator) {
        assertThat(validator.validate(new Profile("xxx", "delamos@unityfoundation.io", TimeZone.getDefault(), DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(16, 30), TimeFormat.TWENTY_FOUR_HOUR_CLOCK,  Format.MARKDOWN,null, null)))
                .isValid();
    }

    @Test
    void fullName() {
        assertThat(new Profile("xxx", "delamos@unityfoundation.io", TimeZone.getDefault(), DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(16, 30), TimeFormat.TWENTY_FOUR_HOUR_CLOCK, Format.MARKDOWN, "Sergio", "del Amo"))
