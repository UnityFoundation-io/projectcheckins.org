...
class ProfileTest {
    ...
    void validProfile(Validator validator) {
        assertThat(validator.validate(new Profile("xx", "delamos@unityfoundation.io", TimeZone.getDefault(), DayOfWeek.MONDAY, TimeFormat.TWENTY_FOUR_HOUR_CLOCK, null, null)))
                .isValid();
    }

    @Test
    void fullName() {
        assertThat(new Profile("xx", "delamos@unityfoundation.io", TimeZone.getDefault(), DayOfWeek.MONDAY, TimeFormat.TWENTY_FOUR_HOUR_CLOCK, "Sergio", "del Amo"))
